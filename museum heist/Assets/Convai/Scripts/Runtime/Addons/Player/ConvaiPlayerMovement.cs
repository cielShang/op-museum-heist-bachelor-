...
namespace Convai.Scripts.Runtime.Addons
{
    ...
    public class ConvaiPlayerMovement : MonoBehaviour
    {
        ...
        [SerializeField] private Animator meshAnimator; // drag your child mesh animator here
        ...
        private void MovePlayer()
        {
            ...
            // after horizontalMovement is computed
                bool isMoving = horizontalMovement.sqrMagnitude > (walkThreshold * walkThreshold);
                if (meshAnimator != null)
                    meshAnimator.SetBool(walkBoolParam, isMoving);
